  ...
  <div className="grid grid-cols-1 sm:grid-cols-6 gap-4">
    ...
    <main className="col-span-1 sm:col-span-5">
      <div className="relative">
        {/* Banner */}
        <img src="/assets/img16.png" alt="Banner" className="w-full h-40 sm:h-64 !object-fill" />
          ...
          return (
            ...
            >
              <div className="relative">
                ...
                <img src={product.image[0]} alt={product.name} className="w-full h-32 sm:h-40 !object-fill mb-2" />
                <button
                  onClick={(e) => {
                    e.stopPropagation();
              ...
              <div className="flex flex-col flex-grow">
                ...
                {product.discount > 0 && (
                  <div className="text-green-500">
                    <p className="line-through text-gray-400 text-xs sm:text-base">{price.toLocaleString()} VNĐ</p>
