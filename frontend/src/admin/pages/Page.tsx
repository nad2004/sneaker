...
const Category = () => (
  <GenericList
    resource="category"
    title="Categories"
    fields={[{ source: 'name', label: 'Category' }]}
  />
);
const CategoryEdit = () => (
  <GenericEdit resource="category" fields={[{ source: 'name', label: 'Category' }]} />
);
const CategoryCreate = () => (
  <GenericCreate resource="category" fields={[{ source: 'name', label: 'Category' }]} />
);
const OrderList = () => (
  <GenericList
    resource="order"
...
const OrderShow = () => <OrderDetails resource="order" />;
