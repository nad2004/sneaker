    ...
    return (
      <Card key={product.id} className="shadow-md rounded-lg w-56">
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          className="relative h-60 flex justify-center items-center bg-gray-100"
        >
          <CardMedia
            component="img"
        ...
        <CardContent className="flex flex-col items-start p-4">
          <Typography className="text-sm font-medium h-12 overflow-hidden text-ellipsis text-start line-clamp-2">
            {product.name}
          </Typography>
    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          whileInView="visible"
          variants={fadeInVariant}
          className="bg-gray-100 min-h-40 flex flex-col items-center"
        >
          {/* Slider Section */}
          <motion.div
            initial="hidden"
            whileInView="visible"
            variants={fadeInVariant}
            className=" w-full md:w-[70%] relative rounded-lg overflow-hidden"
          >
        ...
        <motion.div
          ...
          whileInView="visible"
          variants={fadeInVariant}
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-8 py-4 sm:py-6"
        >
        ...
        <motion.div
          ...
          whileInView="visible"
          variants={fadeInVariant}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 px-4 sm:px-8 pb-6 sm:pb-8"
        >
          {productsSection.map((product) => (
            ...
            >
              ...
              <motion.div
                ...
                whileInView="visible"
                variants={fadeInVariant}
                className="absolute bottom-0 bg-gradient-to-t from-black to-transparent p-4 w-full"
              >
                <h3 className="text-white font-bold text-lg">{product.name}</h3>
                <button
                  onClick={() => navigate('/shop')}
                  className="mt-2 bg-white text-black px-4 py-2 rounded-lg font-semibold hover:bg-gray-400"
                >
                  Shop Now
                </button>
              </motion.div>
      ...
      <SpotlightCard className="custom-spotlight-card mt-4" spotlightColor="rgba(0, 229, 255, 0.2)">
        <motion.div
          ...
          whileInView="visible"
          variants={fadeInVariant}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-12"
        >
          {[...products]
      ...
      <motion.div
        ...
        whileInView="visible"
        variants={fadeInVariant}
        className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4 sm:px-6 mt-6 sm:mt-8"
      >
        {banners.map((banner, index) => (
          <motion.div
            ...
            variants={fadeInVariant}
            key={index}
            className="relative rounded-lg overflow-hidden group h-[300px] sm:h-[400px]"
          >
            {/* Ảnh nền */}
            ...
            <motion.div
              ...
              whileInView="visible"
              variants={fadeInVariant}
              className="absolute inset-0 bg-black/50 group-hover:bg-black/70 transition-all duration-300"
            ></motion.div>
            ...
            <motion.div
              ...
              whileInView="visible"
              variants={fadeInVariant}
              className="absolute inset-0 flex flex-col justify-center px-10 text-white"
            >
              {/* Badge */}
              <span className="bg-orange-300 text-black text-sm font-semibold px-3 py-1 rounded-full w-max">
                Only This Week
      ...
      <motion.div
        ...
        whileInView="visible"
        variants={fadeInVariant}
        className="grid grid-cols-1 lg:grid-cols-3 gap-4 px-4 sm:px-6 mt-6 sm:mt-8"
      >
        {/* Cột trái */}
        <motion.div
          initial="hidden"
          ...
          {[...products]
            ...
            .map((product, index) => (
              <Card key={product.id} className="shadow-md rounded-lg w-56">
                ...
                <CardContent className="flex flex-col items-start p-4">
                  <Typography className="text-sm font-medium h-6 overflow-hidden text-ellipsis text-start line-clamp-2">
                    {product.name}
                  </Typography>
                  <ProductRate productId={product.id} />
                  {/* Giá tiền căn trái và đậm hơn */}
      ...
      <motion.div
        ...
        whileInView="visible"
        variants={fadeInVariant}
        className="w-full overflow-hidden rounded-lg my-8"
      >
        <img src={Image9} alt="Promotional Banner" className="w-full h-auto object-cover" />
      </motion.div>
    </>
  );
};
